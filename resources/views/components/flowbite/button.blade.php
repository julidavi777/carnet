...
@php
    ...
    switch($color)
    {
        ...
        case 'blue':
            ...
            break;
        default:
            $clase = 'text-white bg-'. $color. '-700 hover:bg-'. $color. '-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-'. $color. '-600 dark:hover:bg-'. $color. '-700 dark:focus:ring-blue-800';
            break;
    }
@endphp
