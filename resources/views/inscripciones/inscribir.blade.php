        ...
        <div class="max-w-max mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-r-2 border-gray-200">
                    ...
                    <x-flowbite.label class="mt-4" for="select_jugador">
                        jugador
                    </x-flowbite.label>

                    <x-forms.inscripciones-jugadores />

                    <x-forms.inscripciones-categorias categoria-id='inscripciones-categoria' clases='mt-4' />

                    <div class="text-center">
                        <x-flowbite.button class="mt-4" :color="'purple'" type="button" id="btn-inscripciones-jugador" form="inscripciones-jugador">
                            Agregar
                        </x-flowbite.button>
                    </div>
                </div>
