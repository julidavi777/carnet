            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <input id="numero-identificacion" type="number" name="numero-identificacion" required>
                    </div>
                    <div>
                        <label for="fecha-nacimiento">
                            Fecha nacimiento <span>*</span> 
                        </label>
                        <input id="fecha-nacimiento" type="date" name="fecha-nacimiento" required>
                    </div>
                    <div>
                        <label for="nombres">
                            Nombres <span>*</span> 
                    ...
                    <div>
                        ...
                        <input id="nacionalidad" type="text" name="nacionalidad" required>
                    </div>
                    <div>
                        <label for="telefono-contacto">
                            Número de celular
                        </label>
                        <input id="telefono-contacto" type="text" name="telefono-contacto" required>
                    </div>
                    <div>
                        <label for="email">
                            Correo electrónico
                    ...
                    <div>
                        <label for="pais-residencia">
                            Pais residencia <span>*</span> 
                        </label>
                        <select class="w-full" name="pais-residencia" id="pais-residencia">
                            <option value="-">-- Seleccione --</option>
                            <option value="pais">Pais</option>
                        </select>
                    </div>
                    <div>
                        <label for="ciudad-residencia">
                            Ciudad residencia <span>*</span> 
                        </label>
                        <select class="w-full" name="ciudad-residencia" id="ciudad-residencia">
                            <option value="-">-- Seleccione --</option>
                    ...
                    <div>
                        ...
                        <select class="w-full" name="club" id="club">
                            <option value="-">-- Seleccione --</option>
