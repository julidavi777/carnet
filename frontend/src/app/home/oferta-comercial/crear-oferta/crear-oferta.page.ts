...
export class CrearOfertaPage implements OnInit {
  ...
  onSubmit(){
    ...
    formData.append('sequential_number_format', this.offersForm.get('sequential_number_format').value ? this.offersForm.get('sequential_number_format').value : '');
    ...
    formData.append('assignment_date', this.offersForm.get('assignment_date').value ? this.offersForm.get('assignment_date').value : '');
    ...
    //formData.append('file', this.offersForm.get('anexos').value ? this.offersForm.get('anexos').value : '');
